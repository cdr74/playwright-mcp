 ...
 * changed results more than anything else measured. Every version is a
...
export const PRIMER_VERSIONS = ['v1', 'v2'] as const;
export type PrimerVersion = (typeof PRIMER_VERSIONS)[number];
export const DEFAULT_PRIMER: PrimerVersion = 'v2';
